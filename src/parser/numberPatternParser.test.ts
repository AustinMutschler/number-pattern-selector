...
describe("numberPatternParser", () => {
  describe("single number patterns", () => {
    test("single number", () => {
      ...
      const numbers: number[] | string[] = numberPatternParser(patternString);
    ...
    test("multiple single numbers with some outside of maxNumber", () => {
      ...
      const numbers: number[] | string[] = numberPatternParser(patternString, options);
  ...
  describe("range number patterns", () => {
    ...
    test("range with some numbers greater than max - string", () => {
      const patternString: string = "9:12";
      const options = {
        min: 0,
        max: 10,
  ...
  describe("multi-patterns", () => {
    ...
    test("less than and greater than - string", () => {
      const patternString: string = "<2,>9";
      const numbers: number[] | string[] = numberPatternParser(patternString, {output: 'string'});
      expect(numbers).toEqual(['0', '1', '10']);
    });
  ...
  describe("exclusion patterns", () => {
    ...
    test("range with modulo exclusion of even numbers with extra whitespace - string", () => {
      const patternString: string = "1  : 8,  ! %    2";
      const numbers: number[] | string[] = numberPatternParser(patternString, {output: 'string'});
      expect(numbers).toEqual(['1', '3', '5', '7']);
    });
